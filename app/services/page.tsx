    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-black mb-6" style={{fontFamily: 'var(--font-playfair)'}}>
            For founders & employers
          </h1>
          <p className="text-base uppercase tracking-[0.3em] text-gray-500 font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://cal.com/pranavmurali" target="_blank" rel="noopener noreferrer">
              <Button 
                variant="outline" 
                size="lg" 
                className="border-white text-white hover:bg-white hover:text-black px-8 py-3 rounded-lg cursor-pointer transition-all duration-300"
              >
                Book a call
              </Button>
            </Link>
